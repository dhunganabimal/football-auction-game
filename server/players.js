...
const raw = {
  ...
  DEF: [
    ...
    ['Ibrahima Konaté', 'Real Madrid', 84, 9],
    ...
    // --- new additions ---
    ['Pascal Struijk', 'Brighton', 82, 7],
    ['Andrew Robertson', 'Tottenham', 82, 8],
    ['Marcos Senesi', 'Tottenham', 81, 7],
    ['Jan Paul van Hecke', 'Tottenham', 81, 6],
    ['Jakub Kiwior', 'Porto', 81, 7],
    ['Costinha', 'Brighton', 79, 5],
    ['Jannik Schuster', 'Brentford', 78, 5],
    ['Antonio Silva', 'Benfica', 83, 7],
  ],
  MID: [
    ...
    ['Bernardo Silva', 'Real Madrid', 87, 12],
    ...
    // --- new additions ---
    ['Sandro Tonali', 'Tottenham', 86, 11],
    ['Mateus Fernandes', 'Tottenham', 82, 9],
    ['Elliot Anderson', 'Newcastle', 82, 9],
    ['Adam Wharton', 'Crystal Palace', 82, 8],
    ['Morgan Rogers', 'Aston Villa', 83, 10],
    ['Hayden Hackney', 'Everton', 78, 6],
    ['Odin Bailey', 'Portsmouth', 74, 4],
    ['Manuel Ugarte', 'Man United', 82, 7],
  ],
  FWD: [
    ...
    // --- new additions ---
    ['Robert Lewandowski', 'Chicago Fire', 84, 9],
    ['Hugo Cuypers', 'Chicago Fire', 79, 8],
    ['Rasmus Højlund', 'Napoli', 82, 9],
    ['Anthony Gordon', 'Newcastle', 84, 11],
    ['Bilal El Khannouss', 'Leicester', 79, 6],
    ['Ismaïla Saibari', 'Bayern', 81, 8],
    ['Marcus Rashford', 'Barcelona', 84, 9],
    ['Zadok Yohanna', 'Brighton', 76, 5],
  ],
}
